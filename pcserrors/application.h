...
typedef struct _channel{
	...
	sir_data_per_cell *precise_sir_data; // Signal/Interference Ratio data
	sir_data_per_cell *approx_sir_data; // Signal/Interference Ratio data
...
extern double **pre_power_logs;
extern double **app_power_logs;
extern double **pre_fading_logs;
extern double **app_fading_logs;
extern int *capacity_logs;
