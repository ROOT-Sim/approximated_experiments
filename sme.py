...
def load_rs_data(dir_name):
    ...
    for filename in os.listdir(dir_name):
        ...
        if "pcs" in model_name:
          model_name =model_name+"-"+filename.split("_")[2]
          approx_mode = filename.split("_")[1]
          if approx_mode == "PRECISE": approx_mode="PRECISE"
          else: approx_mode="S1+S2"
...
threads, data = load_rs_data("data")
#plot_model("phold", threads, data)
#plot_model("tbc", threads, data)
#plot_model("pcs-0.06", threads, data)
#plot_model("pcs-0.12", threads, data)
#plot_model("pcs-0.24", threads, data)
plot_model("pcs-0.48", threads, data)
